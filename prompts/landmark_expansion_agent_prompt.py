...
class LandmarkExpansionAgentPrompt:

    GENERATED_TYPE = LandmarkExpansionGeneration
    ...
    def build_prompt_messages(
        ...
        **Health**
        ...
        POOR_HEALTH: Injured, slowed, or impaired (mention injury in fact)
        CRITICAL_HEALTH: Severly injured and limited in movement and capability (mention injury in fact)
        DEAD: No longer animated and will take no actions
        ...
        - **Only describe the character:** Actor fact should not describe where they are, what they are doing, or items they are carrying. Clothes are fine
        ...
        **Checklist:**
        ...
        return [
            ...
            Pay special attention to the landmark fact and ensure the generated entities align with these.
            """)
        ]
